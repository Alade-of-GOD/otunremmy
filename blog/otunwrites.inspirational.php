				...
				<div class="container">
					<nav id="site-navigation" class="main-navigation" role="navigation">
						<ul id="vce_main_navigation_menu" class="nav-menu">
							...
							<li id="menu-item-233" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-233"><a href="otun-remmy-writes.poem.php">Poems</a>
								<ul class="sub-menu">
							...
							<li id="menu-item-212" class="current-menu-item page_item page-item-207 current_page_item menu-item-211"><a href="#">Inspirational</a></li>
				...
				<div id="primary" class="vce-main-content">
					<div class="main-box">
						...
						<div class="main-box-inside">
							<?php
								include ('otun-admin/php/dbfunctions/post.inspirational.shooter.php');
						 	?>
